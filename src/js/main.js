...
let tixAndInfoHover = document.querySelectorAll("#tickets_and_information path");
let tixInfo = document.querySelector("#tickets_and_information")
let fillTixAndInfo = new TimelineMax({});

function loopOverTixText() {
    tixAndInfoHover.forEach(function(letter){
        tixInfo.addEventListener("mouseover", () => {
            fillTixAndInfo.to(letter, .03, {
                fill: "#65a6af",
            })
            tixInfo.addEventListener("mouseout", () => {
                fillTixAndInfo.to(letter, .03, {
                    fill: "white"
                })
            });
...
let aniHomeBtns = new TimelineMax({});

let day1MenuBtn = document.querySelector(".day1-menu-btn");
let day2MenuBtn = document.querySelector(".day2-menu-btn");
let day3MenuBtn = document.querySelector(".day3-menu-btn");
...
let backbtnTween = new TimelineMax({});
...
let beck = document.querySelector(".beck-btn");
let incubus = document.querySelector(".incubus-btn");
let tame = document.querySelector(".tame-btn");
let maggie = document.querySelector(".maggie-btn");
let caaamp = document.querySelector(".caamp-btn");
let jim = document.querySelector(".jim-btn");
let foals = document.querySelector(".foals-btn");
let grouplove = document.querySelector(".grouplove-btn");
let cage = document.querySelector(".cage-btn");
let interpol = document.querySelector(".interpol-btn");
let struts = document.querySelector(".struts-btn");
...
let videoChange = document.querySelector("body");
...
incubus.addEventListener("click", () => {
    animateVideoIn();
    lightbox.style.display = "block";
    lightboxBg.style.display = "block";
...
grouplove.addEventListener("click", () => {
    animateVideoIn();
    lightbox.style.display = "block";
    lightboxBg.style.display = "block";
...
interpol.addEventListener("click", () => {
    animateVideoIn();
    lightbox.style.display = "block";
    lightboxBg.style.display = "block";
